...
public class ProfileTest extends BasicTest {
	...
	public void editProfile() throws Exception {
		...
		pp.updateProfile("Zarko", "Jovanovic", "Vojvode Tankosica", "+3816254821", "18000", "United States", "Maryland",
				"Silver Spring");
	...
	public void ChangeProfileImage() throws Exception {
		...
		Assert.assertEquals(succesfullUpload, "Profile Image Uploaded Successfully",
				"[ERROR] Profile image didn't upload");
